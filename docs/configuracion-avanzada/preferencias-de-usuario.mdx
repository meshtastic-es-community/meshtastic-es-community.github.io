...
El primer paso es obtener el código fuente del firmware de Meshtastic en tu equipo local:
...
5. Escribe `PlatformIO: Build` para iniciar la compilación. También puedes hacerlo desde el panel lateral de PlatformIO seleccionando el modelo exacto de tu dispositivo (_Target_) y haciendo clic en **Build**.
