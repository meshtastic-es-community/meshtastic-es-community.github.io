...
<Tabs groupId="preset">
    ...
    <TabItem value="mediumslow" label="MediumSlow">
        <div className="container">
            <div className="row">
                <div className="col" style={{flex: 0}}>
                    <QRCode value="https://meshtastic.org/e/#CgsSAQEoATABOgIIDwoREgEBGgZJYmVyaWEoATABOgASFAgBEAM4A0ADSAFQG2gBwAYByAYB" size={200} className={`qr-code shadow--lw`} />
                </div>
                <div className="col">
                    Los datos de los canales son:
        ...
        Enlace directo: https://meshtastic.org/e/#CgsSAQEoATABOgIIDwoREgEBGgZJYmVyaWEoATABOgASFAgBEAM4A0ADSAFQG2gBwAYByAYB
    </TabItem>
</Tabs>
