...
- Selecciona o confirma los siguientes valores:
    ...
    | _Saltos_                   | **3** (el valor de fábrica). Consulta las [buenas prácticas de saltos](../buenas-practicas.md#cantidad-de-saltos-máxima). |
...
Accede [aquí al generador de QRs](../generador-configuracion.mdx).

:::tip
Comprueba qué preset se usa en tu zona en el [mapa de Presets](../mapas.md#mapa-presets) o en [Meshview](https://meshview.meshtastic.es).
:::
...
El objetivo de habilitar up y downlink en todos los canales es poder usar [herramientas](../mapas.md) de diagnóstico para estudiar, pulir y tener vision sobre el correcto funcionamiento de la malla.

[Más info](../preguntas-frecuentes.md#mqtt-downlink)
:::
---
