...
<div style={{ textAlign: 'center' }}>
  <img src="/img/guias/Android1.jpg" alt="Android 1" width="200" />
    ...
    <TabItem value="ios" label="iOS">
        Captura pendiente de añadir {/* Estaría bien poner aquí una captura de pantalla de un iOS buscando dispositivos Bluetooth */}
    </TabItem>
</Tabs>
...
<Tabs groupId="operating-system">
    ...
    <TabItem value="ios" label="iOS">
       Captura pendiente de añadir {/* Estaría bien poner aquí una captura de pantalla de la app de iOS conectando con el dispositivo */}
    </TabItem>
</Tabs>
