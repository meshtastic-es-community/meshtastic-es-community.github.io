...
## Descarga y accede al cliente<InlineIcon icon="mdi:tablet-cellphone" />
...
## Conectar al dispositivo<InlineIcon icon="mdi:bluetooth-connect" />
...
## Elige un nombre para el nodo<InlineIcon icon="mdi:identification-card-outline" />
...
## Configura la región y el _preset_<InlineIcon icon="mdi:access-point-network" />
...
## Canales públicos<InlineIcon icon="mdi:speak" />
