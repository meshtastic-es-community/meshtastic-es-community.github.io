...
:::info
Comprueba que preset se usa en tu zona en el [mapa de Presets.](../mapas#mapa-presets)
:::
...
<Tabs groupId="preset">
    ...
    <TabItem value="mediumfast" label="MediumFast (en Madrid y Ciudad Real)">
        <div className="container">
            <div className="row">
                <div className="col" style={{flex: 0}}>
                    <QRCode value="" size={200} className={`qr-code shadow--lw`} />
                </div>
                <div className="col">
                    Los datos de los canales son:
    ...
    <TabItem value="mediumslow" label="MediumSlow (Murcia)">
        <div className="container">
            <div className="row">
                <div className="col" style={{flex: 0}}>
